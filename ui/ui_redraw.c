...
void ui_redraw_clear_region(DirtyFlags *flags, int region) {
    ...
    switch (region) {
        case 0: flags->header_dirty = false; break;
        case 1: flags->sidebar_dirty = false; break;
        case 2: flags->content_dirty = false; break;
        case 3: flags->footer_dirty = false; break;
        case 4: flags->status_dirty = false; break;
        case 5: flags->dialog_dirty = false; break;
    }
}
